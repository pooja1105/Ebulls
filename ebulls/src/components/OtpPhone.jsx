        ...
        <Grid container className={classes.main9}>
          <Grid item xs={6}>
            ...
            <div className={classes.divpara91}>
              ...
              elit. Adipiscing consequat aliquam, metus, ultrices sed. In felis consectetur sit elit <br/>
            ...
            <Card className={classes.card9}>
              <CardContent>
                ...
                <div className={classes.codeverify}>
                 <Link to='/otp-email'> <p className={classes.swiitch}>
                    Swith to Email verification.
                  </p></Link>
                </div>
